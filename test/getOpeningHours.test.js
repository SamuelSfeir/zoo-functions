...
describe('Testes da função getOpeningHours', () => {
  ...
  it('Não passando argumento, deve retornar os dias e horários de funcionamento', () => {
    const expected = {
    ...
    const received = getOpeningHours();
    expect(received).toEqual(expected);
  });

  it('Para os argumentos Thu e 09:00-AM deve lançar uma exceção com a mensagem: Invalid day', () => {
